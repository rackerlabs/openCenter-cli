...
type TempoConfig struct {
	...
	StorageType  string `yaml:"storage_type,omitempty" json:"storage_type,omitempty" jsonschema:"description=Tempo storage backend type (s3 or swift),enum=s3,enum=swift,default=s3"`
	BucketName   string `yaml:"bucket_name,omitempty" json:"bucket_name,omitempty" jsonschema:"description=Tempo storage bucket/container name"`
	VolumeSize   int    `yaml:"volume_size,omitempty" json:"volume_size,omitempty" jsonschema:"description=Tempo persistent volume size in GB"`
	StorageClass string `yaml:"storage_class,omitempty" json:"storage_class,omitempty" jsonschema:"description=Tempo storage class"`
