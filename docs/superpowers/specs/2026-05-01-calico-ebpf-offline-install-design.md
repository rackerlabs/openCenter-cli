...
- CRDs: https://raw.githubusercontent.com/projectcalico/calico/v3.32.0/manifests/v1_crd_projectcalico_org.yaml
...
- the fake runner sees `kubectl apply` for the CRDs, operator, and patched eBPF custom resources in order.
