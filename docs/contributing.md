...
4.  **Update Interactive Init**: If you want the field to be prompted for during an interactive `init`, add it to the `runInitInteractive` function in `cmd/cluster_init_interactive.go`.
